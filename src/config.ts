...
const EnvSchema = z.object({
  ...
  SCHEDULE_SYNC_INTERVAL_MS: z.coerce.number().int().positive().default(30 * 60 * 1000),
  SCORE_SYNC_INTERVAL_MS: z.coerce.number().int().positive().default(60 * 1000),
  HEALTH_WORKER_STALE_MS: z.coerce.number().int().positive().default(3 * 60 * 1000),
  HEALTH_PUBLICATION_STALE_MS: z.coerce.number().int().positive().default(15 * 60 * 1000),
  HEALTH_PROVIDER_STALE_MS: z.coerce.number().int().positive().default(10 * 60 * 1000),
